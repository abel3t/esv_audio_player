...
import 'package:esv_audio_player/Helpers/picker.dart';
import 'package:esv_audio_player/Screens/Home/trending.dart' as trendingScreen;
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Share.share(
                            'Hey! Check out this cool music player app: https://github.com/Sangwan5688/ESV Audio Player');
                      },
                      dense: true,
                    ),
                    ListTile(
